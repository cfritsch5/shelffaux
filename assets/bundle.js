...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  function draw(x, y) {
    ...
    for (var i = 0; i < _books3.default.length; i++) {
      ...
      book = new _book2.default(books[i].cover, books[i].spine, Rposition, Rposition + 50);
      book.draw(ctx, x, y);
      Rposition += 50;
    }
  }
...
var Book = function () {
  function Book(CoverImage, SpineImage, leftBorder, rightBorder, topSpace, width, height, author, title) {
